...
public class GokartParkingModule extends AbstractModule implements GokartPoseListener {
  ...
  protected void first() throws Exception {
    ...
    GlobalAssert.that(Objects.nonNull(gokartPoseEvent));
    System.out.println("Calculating parking maneuver...");
    ...
    if (!head.isEmpty()) {
      Tensor goal = Tensors.vector(0, 0, 0);
      ...
      Se2ComboRegion se2ComboRegion = //
          Se2ComboRegion.spherical(goal, goalRadius);
